...
public class HttpClientGet {
	...
	public static String sendGetToGaoDe(String url, LinkedHashMap<String, String> map) {
		...
		logger.info("sendGetToGaoDe Req: " + urlNameString.trim());
		String returnParams = urlReturnParamsAs(urlNameString);

		logger.info("sendGetToGaoDe Resp: " + returnParams.trim());
		return returnParams;
	}
	...
	public static String urlReturnParams(String urlNameString) {
		...
		try {
			...
			httpConnect.setRequestProperty("user-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1;SV1)");
			httpConnect.connect();
