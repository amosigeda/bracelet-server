...
//	U_BINGDING_ERR(26, "设备绑定失败，请核对设备信息！"),
	...
	// sos白名单
	WL_DEVICE_OFFLINE(41, "白名单修改成功,设备不在线！"),
	WL_ALREADY_EXIT(40, "该电话已经加入白名单"),
	//控制设备走点
	CC_DEVICE_point(42, "已经通知设备开始走点，不需重复下发"),
	//微信登录
	WECHAT_LOGIN_ERR(40029, "微信授权失败")
	;
